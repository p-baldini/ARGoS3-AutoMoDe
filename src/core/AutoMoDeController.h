...
namespace argos{
    class AutoMoDeController: public CCI_Controller {
        public:
            ...
            /**
             * Setter for the robot evaluator.
             */
            void SetEvaluator(AutoMoDeEvaluator* pcEvaluator);
        ...
        private:
            ...
            std::string m_strEvaluatorType;     ///< The type of the evaluator employed by the
                                                ///< robot.
